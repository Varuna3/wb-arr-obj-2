...
evenNumbers = mixedNumbers.filter(e => e % 2 === 0)
...
postTaxPrices = prices.map(e => e * 1.07)
...
totalPopulation = populations.reduce((acc, curr) => acc + curr)
...
myStrongest = monstersInYourPocket.filter(e => e.CP > 200)
...
let bobsTotal
bobsTotal = purchases.reduce((acc, curr) => {
  if(curr.owner === 'Bob') {
